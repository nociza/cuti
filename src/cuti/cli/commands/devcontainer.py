...
@app.command()
def init(
    project_type: str | None = typer.Option(None, "--type", "-t", help="Project type (python, javascript, fullstack, etc.)"),
    ...
    service = DevContainerService(str(working_dir))
