...
from .base import AgentCapability, AgentConfig, AgentStatus, BaseAgent
...
class AgentPool:
    ...
    async def select_best_agent(self, prompt: QueuedPrompt) -> BaseAgent | None:
    ...
    def select_agent_round_robin(self) -> BaseAgent | None:
