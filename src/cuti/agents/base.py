...
class BaseAgent(ABC):
    ...
    async def estimate_execution_time(self, prompt: QueuedPrompt) -> int | None:
        """
    ...
    async def estimate_cost(self, prompt: QueuedPrompt) -> float | None:
        """
    ...
    def add_execution(self, prompt_id: str, prompt: QueuedPrompt) -> None:
    ...
    def remove_execution(self, prompt_id: str) -> None:
