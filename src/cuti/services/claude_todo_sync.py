...
from ..core.todo_models import TodoItem, TodoList, TodoSession, TodoStatus
...
class ClaudeTodoSync:
    ...
    def __init__(self, storage_dir: str = ".cuti") -> None:
        ...
        self.current_session: TodoSession = self._init_session()

    def _init_session(self) -> TodoSession:
    ...
    def capture_todo_write(self, todos: list[dict[str, Any]],
                          agent_name: str | None = None) -> TodoList:
        """
    ...
    def _check_master_goal_completion(self, completed_todo: TodoItem) -> None:
    ...
    def suggest_next_todo(self) -> TodoItem | None:
