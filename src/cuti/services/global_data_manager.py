...
"""
    ...
    def _update_project_stats(self, conn: sqlite3.Connection, project_path: str) -> None:
    ...
    def get_usage_stats(self,
        ...
        with sqlite3.connect(str(self.db_path), timeout=30.0) as conn:
            ...
            params: list[Any] = [datetime.now() - timedelta(days=days)]
    ...
    def get_favorite_prompts(self,
                            ...
                            tags: list[str] | None = None) -> list[FavoritePrompt]:
        """
    ...
    def use_favorite_prompt(self, prompt_id: str) -> None:
    ...
    def cleanup_old_data(self, days: int | None = None) -> None:
        """
    ...
    def export_data(self, output_path: str, format: str = 'json') -> bool:
        ...
        try:
            with sqlite3.connect(str(self.db_path), timeout=30.0) as conn:
                ...
                columns = [desc[0] for desc in cursor.description]
                for row in cursor.fetchall():
                    favorite = dict(zip(columns, row, strict=False))
