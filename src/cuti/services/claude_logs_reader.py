...
class ClaudeLogsReader:
    ...
    def get_prompt_history(self, session_id: str | None = None, limit: int = 100) -> list[dict[str, Any]]:
        """
    ...
    def get_todos(self, session_id: str | None = None) -> list[dict[str, Any]]:
        """
    ...
    def get_conversation_context(self, session_id: str | None = None, limit: int = 10) -> list[dict[str, Any]]:
        """
        ...
        assistant_responses: dict[str | None, dict[str, Any]] = {}
