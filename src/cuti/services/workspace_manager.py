...
class WorkspaceManager:
    ...
    def _create_initial_config(self, config_file: Path) -> None:
    ...
    def _init_history_db(self, db_path: Path) -> None:
    ...
    def _init_metrics_db(self, db_path: Path) -> None:
    ...
    def _init_agents_db(self, db_path: Path) -> None:
