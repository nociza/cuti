...
class WorkspaceToolsManager:
    ...
    def _create_tool_wrapper(self, tool_name: str, tool_config: dict[str, Any],
                            bin_dir: Path, lib_dir: Path) -> None:
...
"""
    ...
    def activate_workspace_tools(self) -> str:
    ...
    def sync_with_container(self) -> None:
    ...
    def import_tools_config(self, config: dict[str, Any]) -> None:
...
def setup_workspace_tools_on_container_start() -> WorkspaceToolsManager:
...
def setup_shell_auto_activation() -> None:
