...
class ContainerUsageSync:
    ...
    def __init__(self) -> None:
        ...
        self.container_claude_path: Path | None
        self.host_cuti_path: Path
        self.alt_host_path: Path | None
    ...
    def sync_usage_data(self) -> int:
        ...
        try:
            ...
            if self.container_claude_path is None:
                return 0
    ...
    def _sync_claude_monitor_data(self, cursor: sqlite3.Cursor, monitor_path: Path) -> int:
...
_container_sync: ContainerUsageSync | None = None
...
def start_container_sync(interval: int = 300) -> None:
