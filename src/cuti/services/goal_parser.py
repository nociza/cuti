...
class GoalParser:
    ...
    def __init__(self, goal_file_path: Path | None = None):
    ...
    def sync_with_database(self, todo_service: Any, master_list: TodoList) -> TodoList:
    ...
    def write_goal_file(self, master_list: TodoList) -> None:
        ...
        categories: dict[str, list[TodoItem]] = {}
