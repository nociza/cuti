...
class ClaudeUsageMonitor:
    ...
    def __init__(self,
                 claude_data_path: str | None = None,
                 plan: str = 'pro',
                 storage_dir: str = "~/.cuti") -> None:
        """
        ...
        if claude_data_path:
            self.claude_data_path: Path | None = Path(claude_data_path).expanduser()
        else:
    ...
    def _find_claude_data_path(self) -> Path | None:
    ...
    def store_usage_data(self, usage_records: list[TokenUsage]) -> None:
    ...
    def _update_session(self, conn: sqlite3.Connection, record: TokenUsage) -> None:
    ...
    def update_plan_limits(self, daily_limit: int, monthly_limit: int) -> None:
